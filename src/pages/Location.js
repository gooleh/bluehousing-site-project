    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="container-content py-14 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-white dark:bg-gray-800 p-7 rounded-2xl shadow-card">
            <div className="flex items-center gap-2 mb-3">
              <RiMapPinLine className="text-2xl text-brand-600" />
              <h2 className="text-lg font-bold text-ink dark:text-gray-100">주소</h2>
            </div>
            <p className="text-ink-soft dark:text-gray-300 leading-relaxed">
              {company.roadAddress}<br />
              <span className="text-ink-muted dark:text-gray-400 text-sm">{company.addressDetail}</span>
            </p>
            <p className="mt-3 text-ink-soft dark:text-gray-300 leading-relaxed">
              <span className="font-semibold text-ink dark:text-gray-100">지번 주소</span><br />
          ...
          <div className="bg-white dark:bg-gray-800 p-7 rounded-2xl shadow-card">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-lg font-bold text-ink dark:text-gray-100">대중교통</h2>
            </div>
            <p className="text-ink-soft dark:text-gray-300 leading-relaxed">
              {company.transit}
            </p>
            ...
            <div className="flex items-center gap-2 mt-5 mb-3">
              ...
              <h2 className="text-lg font-bold text-ink dark:text-gray-100">대표번호</h2>
            </div>
            <a href={`tel:${company.phone.raw}`} className="text-brand-700 dark:text-brand-400 font-semibold hover:underline">
